...
const MedicalHistory = ({ id =null }) =>{
  ...
  return(
    <div className="form_containter edit_patient_containter f-center glassmorphism shadow">
      <div className="edit_patients medical_history_form glassmorphism shadow">
        <form action="">
          <h1>Edit Patient</h1>
          <br />
